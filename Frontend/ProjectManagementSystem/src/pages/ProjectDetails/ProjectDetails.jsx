...
import { fetchProjectById, updateProjectStatus } from "../../redux/Project/Action";
...
function ProjectDetails() {
    ...
    const handleStatusChange = async (newStatus) => {
        ...
        try {
            ...
            await dispatch(updateProjectStatus(id, newStatus));
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        >
                                            ...
                                            <SelectContent className="bg-slate-800 border-slate-700">
                                                <SelectItem value="ACTIVE" className="text-slate-200 hover:bg-slate-700 focus:bg-slate-700">
                                                    Active
                                                </SelectItem>
                                                <SelectItem value="CLOSED" className="text-slate-200 hover:bg-slate-700 focus:bg-slate-700">
                                                    Closed
                                                </SelectItem>
                                            </SelectContent>
                                        </Select>
